            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">Formulir Surat Pengadaan</h4>
                        <p>Lengkapi data berikut untuk proses pengadaan barang</p>
                    </div>
                    <form id="editUserForm" class="row g-6" onsubmit="return false" enctype="multipart/form-data">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" id="suratKode" name="suratKode" class="form-control"
                                value="{{ $noSurat }}" readonly disabled />
                        </div>
                        <div class="col-12 col-md-6">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="numeric" id="barangJumlah" name="barangJumlah" class="form-control"
                                placeholder="" value="" />
                        </div>
                        <div class="col-12 col-md-6">
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            if (dt_product_table) {
                var dt_products = new DataTable(dt_product_table, {
                    processing: true,
                    serverSide: true,
                    ajax: '{{ route('surat-pengadaan.show') }}',
                    columns: [{
                            data: 'no_surat',
                            name: 'no_surat'
                        },
