        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar me-4">
                            <span class="avatar-initial rounded bg-label-primary"><i
                                    class="icon-base ti tabler-packages icon-28px"></i></span>
                        </div>
                    ...
                    <p class="mb-0">
                        <span
                            class="text-heading fw-medium me-2 {{ $barangInfo['naik'] ? 'text-success' : 'text-danger' }}">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar me-4">
                            <span class="avatar-initial rounded bg-label-warning"><i
                                    class="icon-base ti tabler-mail-down icon-28px"></i></span>
                        </div>
                    ...
                    <p class="mb-0">
                        <span
                            class="text-heading fw-medium me-2 {{ $pengambilanInfo['naik'] ? 'text-success' : 'text-danger' }}">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card card-border-shadow-danger h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar me-4">
                            <span class="avatar-initial rounded bg-label-danger"><i
                                    class="icon-base ti tabler-mail-up icon-28px"></i></span>
                        </div>
                    ...
                    <p class="mb-0">
                        <span
                            class="text-heading fw-medium me-2 {{ $pengadaanInfo['naik'] ? 'text-success' : 'text-danger' }}">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="card card-border-shadow-info h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar me-4">
                            <span class="avatar-initial rounded bg-label-info"><i
                                    class="icon-base ti tabler-clock-bolt icon-28px"></i></span>
                        </div>
                    ...
                    <p class="mb-0">
                        <span
                            class="text-heading fw-medium me-2 {{ $pengadaanMendesakInfo['naik'] ? 'text-success' : 'text-danger' }}">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-none d-lg-flex vehicles-progress-labels mb-6">
                        ...
                        <div class="vehicles-progress-label waiting-text text-nowrap text-center" style="width: 25%;">
                            Selesai</div>
                    </div>
                    <div class="vehicles-overview-progress progress rounded-3 mb-3 bg-transparent overflow-hidden"
                        style="height: 46px">
                        <div class="progress-bar fw-medium text-start shadow-none bg-warning text-paper px-4 rounded-0"
                            role="progressbar" style="width: 25%">
                            {{ $statuses['percentages']['Diproses'] }}%
                        </div>

                        <div class="progress-bar fw-medium text-start shadow-none bg-success px-4" role="progressbar"
                            style="width: 25%">
                            {{ $statuses['percentages']['Disetujui'] }}%
                        </div>

                        <div class="progress-bar fw-medium text-start shadow-none bg-maroon px-2 px-sm-4" role="progressbar"
                            style="width: 25%">
                            {{ $statuses['percentages']['Ditolak'] }}%
                        </div>

                        <div class="progress-bar bg-light fw-medium text-start shadow-none snackbar text-heading px-1 px-sm-3 rounded-0 px-lg-4"
                            role="progressbar" style="width: 25%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end pe-0 text-nowrap">
                                        <h6 class="mb-0">{{ $statuses['counts']['Diproses'] }} Surat</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0 text-nowrap">
                                        <h6 class="mb-0">{{ $statuses['counts']['Disetujui'] }} Surat</h6>
                                    </td>
                                    <td class="text-end pe-0"><span>{{ $statuses['percentages']['Disetujui'] }}%</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0 text-nowrap">
                                        <h6 class="mb-0">{{ $statuses['counts']['Ditolak'] }} Surat</h6>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0 text-nowrap">
                                        <h6 class="mb-0">{{ $statuses['counts']['Selesai'] }} Surat</h6>
                                    </td>
                                ...
                                labels: {
                                    ...
                                    total: {
                                        ...
                                        formatter: function(w) {
                                            return 'Rp ' + parseInt({{ $anggaran['sisa_anggaran'] ?? 0 }})
