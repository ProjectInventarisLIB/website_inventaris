...
@section('content')
            ...
            <div class="d-flex justify-content-between flex-wrap gap-4 me-12">
                <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                    ...
                    <div class="content-right">
                        <p class="mb-0 fw-medium">Total Barang</p>
                ...
                <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                            ...
                            <div class="text-primary">
                                <svg width="38" height="38" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="currentColor" />
                                    <path d="M8 13C5.33 13 2 14.34 2 17V19H14V17C14 14.34 10.67 13 8 13Z"
                                        fill="currentColor" />
                                    <path
                                        d="M16 13C15.5593 13 15.1032 13.0381 14.6422 13.1104C15.8479 14.0155 16.5 15.1895 16.5 17V19H22V17C22 14.34 18.67 13 16 13Z"
                                        fill="currentColor" />
                                </svg>
                            </div>
                        </div>
                    ...
                    <div class="content-right">
                        <p class="mb-0 fw-medium">Total Vendor</p>
                        <h4 class="text-primary mb-0">34</h4>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="content-right">
                        <p class="mb-0 fw-medium">Total Staf</p>
                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="content-right">
                        <p class="mb-0 fw-medium">Total Surat</p>
                        <h4 class="text-warning mb-0">140</h4>
                    </div>
                </div>
                <div class="d-flex align-items-center gap-4">
                    <div class="avatar avatar-lg">
                        <div class="avatar-initial bg-label-warning rounded">
                            <div class="text-warning">
                                <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 128 128"
                                    fill="currentColor">
                                    <path
                    ...
                    <div class="content-right">
                        ...
                        <h4 class="text-warning mb-0">180</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-6">
            ...
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="mb-1">Lacak Barang</h5>
                        <p class="card-subtitle">Total Barang 1.967</p>
                    </div>
                    <div class="btn-group">
                        <button type="button" class="btn btn-label-primary">Januari</button>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="javascript:void(0);">Februar</a></li>
        ...
        <div class="col-md-6 order-md-3 order-lg-0">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title mb-0">
                        <h5 class="mb-1">Lacak Penanganan</h5>
                ...
                <div class="card-body row">
                    <div class="col-12 col-sm-4">
                        <div class="mt-3 mb-4">
                            <h2 class="mb-0">184</h2>
                            <p class="mb-0">Menunggu Penanganan</p>
                        </div>
                        <ul class="list-unstyled">
                            <li class="d-flex align-items-center gap-3 mb-3">
                                <div class="badge rounded bg-label-primary p-2">
                                    <i class="icon-base ti tabler-smart-home icon-md"></i>
                                </div>
                                <div>
                                    <h6 class="mb-0 text-nowrap">Surat Pengadaan</h6>
                            ...
                            <li class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <div>
                                    <h6 class="mb-0 text-nowrap">Surat Pengambilan</h6>
                            ...
                            <li class="d-flex align-items-center gap-3 mb-3">
                                ...
                                <div>
                                    <h6 class="mb-0 text-nowrap">Quotation Order</h6>
                            ...
                            <li class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h6 class="mb-0 text-nowrap">Purchase Order</h6>
        ...
        <!-- Anggaran Tahunan Staf -->
        <div class="col-md-6 order-md-3 order-lg-0">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title m-0 me-2">
                        <h5 class="mb-1">Anggaran Tahunan Staf</h5>
                        <p class="card-subtitle">Periode 2022</p>
                    </div>
                    <div class="dropdown">
                        <button class="btn btn-text-secondary btn-icon rounded-pill text-body-secondary border-0 me-n1"
                            type="button" id="employeeList" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                ...
                <div class="card-body">
                    <ul class="p-0 m-0">
                        <li class="d-flex align-items-center mb-6 justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="badge bg-label-secondary text-body p-2 me-4 rounded">
                                    <i class="icon-base ti tabler-user icon-md"></i>
                                </div>
                                <div>
                                    <h6 class="mb-1_5">Staf HRD</h6>
                                    <small>10.000.000 / 4.000.000</small>
                                </div>
                            </div>
                            <div class="chart-progress me-4" data-color="warning" data-series="40"
                        ...
                        <li class="d-flex align-items-center mb-6 justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1_5">Staf HRD</h6>
                                    <small>10.000.000 / 7.000.000</small>
                                </div>
                            </div>
                            <div class="chart-progress me-4" data-color="danger" data-series="70"
                                data-progress_variant="true"></div>
                        </li>
                        <li class="d-flex align-items-center mb-6 justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1_5">Staf HRD</h6>
                                    <small>10.000.000 / 2.000.000</small>
                                </div>
                            </div>
                            <div class="chart-progress me-4" data-color="primary" data-series="20"
                                data-progress_variant="true"></div>
                        </li>
                        <li class="d-flex align-items-center mb-6 justify-content-between">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1_5">Staf HRD</h6>
                                    <small>10.000.000 / 8.000.000</small>
                                </div>
                            </div>
                            <div class="chart-progress me-4" data-color="success" data-series="80"
                                data-progress_variant="true"></div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card h-100">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 card-title">Total Permohonan</h5>
                        <div class="dropdown">
                            <button class="btn btn-text-secondary rounded-pill text-body-secondary border-0 p-2 me-n1"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start my-4">
                        <div class="badge rounded bg-label-primary p-2 me-4 rounded">
                            <i class="icon-base ti tabler-arrow-up icon-md"></i>
                        </div>
                        <div class="d-flex justify-content-between w-100 gap-2 align-items-center">
                            <div class="me-2">
                                <h6 class="mb-0">Pengadaan</h6>
                                <small class="text-body">Permohonan Pengadaan</small>
                            </div>
                    ...
                    <div class="d-flex align-items-start">
                        <div class="badge rounded bg-label-secondary p-2 me-4 rounded">
                            <i class="icon-base ti tabler-arrow-down icon-md"></i>
                        </div>
                        <div class="d-flex justify-content-between w-100 gap-2 align-items-center">
                            <div class="me-2">
                                <h6 class="mb-0">Pengambilan</h6>
                                <small class="text-body">Permohonan Pengambilan</small>
                            </div>
