            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">Formulir Order</h4>
                        <p>Lengkapi data berikut untuk permintaan order</p>
                    </div>
                    <form id="editUserForm" class="row g-6" onsubmit="return false" enctype="multipart/form-data">
                        <div class="col-12">
                            <label class="form-label" for="idPengadaan">ID Qotation Order</label>
                        ...
                        <div class="col-12">
                            <label class="form-label" for="barangDeskripsi">Spesifikasi</label>
                        ...
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-primary me-3">Kirim Permintaan</button>
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            if (dt_product_table) {
                dt_products = new DataTable(dt_product_table, {
                    processing: true,
                    serverSide: false,
                    ajax: assetsPath + 'json/DummyBackend/order.json', // JSON file to add data
                    columns: [{
                            data: 'tanggal-no',
                            name: 'tanggal-no'
                        },
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end m-0">
                                        <a href="javascript:;" class="dropdown-item edit-record">
                                            <i class="icon-base ti tabler-file-description icon-22px me-1"></i> Cetak
                                        </a>
