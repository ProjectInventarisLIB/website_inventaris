            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-6">
                        <h4 class="mb-2">Formulir Master Barang</h4>
                        <p>Lengkapi data berikut untuk pendataan master barang</p>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function(e) {
            ...
            if (dt_product_table) {
                dt_products = new DataTable(dt_product_table, {
                    processing: true,
                    serverSide: false,
                    ajax: assetsPath + 'json/DummyBackend/master_data.json', // JSON file to add data
                    columns: [{
                            data: 'gambar',
                            name: 'gambar'
                        },
